...
class AmulBackwardOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    AmulBackwardKernelLauncher(input.data(), weight.data(), grad_output.data(), grad_input.data(), grad_weight.data(), axis, batchSize, input_xSize, input_ySize, input_zSize, numChannels);
